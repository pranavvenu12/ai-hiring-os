        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden font-inter py-12 px-6">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input type="email" className="w-full bg-white/50 border border-slate-200 rounded-2xl py-4 pl-12 pr-4 outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/5 transition-all font-medium" placeholder="john@acme.com" value={email} onChange={e => setEmail(e.target.value)} required />
                        </div>
                    </div>
                ...
                <div className="mt-10 pt-8 border-t border-slate-200/50">
                    <button className="flex items-center justify-center gap-3 w-full bg-white border border-slate-200 rounded-2xl py-3.5 font-bold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm mb-6">
