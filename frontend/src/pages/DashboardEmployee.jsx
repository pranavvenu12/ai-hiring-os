                                        ...
                                        {attendanceData.today?.clocked_in ? (
                                            attendanceData.today?.clocked_out ? (
                                                ...
                                                <span className="text-indigo-600 font-bold">
                                                    Currently Clocked In since {new Date(attendanceData.today.clock_in).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} Â· {formatAttendanceDuration(attendanceData.today, now)}
                                                </span>
                                            )
                                        ) : (
