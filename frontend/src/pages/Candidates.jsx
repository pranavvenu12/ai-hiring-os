                            ...
                            <div className="p-8 border-b border-slate-100 sticky top-0 bg-white/80 backdrop-blur-md z-10">
                                ...
                                <div className="flex border-b border-slate-100 gap-6 mt-4">
                                    <button 
                                        ...
                                        className={`pb-3 text-xs font-black uppercase tracking-widest border-b-2 transition-all ${activeTab === 'resume' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
                                    >
                                        Resume Insights
                                    </button>
                                    <button 
                                        onClick={() => setActiveTab('interview')}
                                        className={`pb-3 text-xs font-black uppercase tracking-widest border-b-2 transition-all flex items-center gap-2 ${activeTab === 'interview' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
                                    >
                                        ...
                                        {loadingInterviews ? (
                                            ...
                                            candidateInterviews.map((session) => (
                                                <div key={session.id} className="space-y-8">
                                                    ...
                                                    <div className="bg-gradient-to-br from-slate-900 to-indigo-950 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-xl shadow-slate-900/30">
                                                        <div className="flex justify-between items-start mb-6">
                                                            <div>
                                                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-300">AI INTERVIEW REPORT</span>
                                                                <h4 className="text-2xl font-black mt-1 capitalize">{session.interview_type} Session</h4>
                                                            </div>
                                                        ...
                                                        <div className="mt-6 pt-2">
                                                            <h5 className="text-xs font-black uppercase tracking-widest text-indigo-300 mb-2">AI Summary</h5>
                                                            ...
                                                            {session.transcript && session.transcript.length > 0 ? (
                                                                session.transcript.map((qa, index) => (
                                                                    <div key={index} className="pt-4 space-y-2">
                                                                        <div className="text-xs font-black text-indigo-600">Q{index + 1}: {qa.question}</div>
                                            ...
                                            <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
                                                ...
                                                <div>
                                                    <h4 className="text-lg font-black text-slate-900">No Interview Found</h4>
